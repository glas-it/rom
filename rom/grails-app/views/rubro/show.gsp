...
<section id="show-rubro" class="first">
	...
	<table class="table">
		<tbody>
			...
			<tr class="prop">
				<td valign="top" class="name"><g:message code="rubro.descripcion.label" default="Descripcion" /></td>
				
				<td valign="top" class="value">${fieldValue(bean: rubroInstance, field: "descripcion")}</td>
