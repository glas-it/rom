...
for ((i=10; i<15; i++)); do 
	...
	# alta de orden
	curl --data "idRestaurant=1&idMesa=$nroMesa&platos=[{'idConsumicion':3,'observaciones':'alta de coso','idAgregado': 0,'precio':{'descripcion':'-'},'id':'$i'}]" http://localhost:8080/rom/orden/alta
